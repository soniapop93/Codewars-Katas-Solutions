/*
 * LINK: https://www.codewars.com/kata/56541980fa08ab47a0000040/train/csharp
 * 
...
namespace CodewarsKatas._7_kyu.Printer_Errors
{
    public class PrinterErrors
    {
        public static string PrinterError(String s)
        {
            ...
            return countNumerator.ToString() + "/" + s.Length.ToString();
        }
    }
}
