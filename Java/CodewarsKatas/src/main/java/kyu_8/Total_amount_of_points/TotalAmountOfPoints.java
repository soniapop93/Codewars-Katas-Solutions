/*
LINK: https://www.codewars.com/kata/5bb904724c47249b10000131/train/java
...
public class TotalAmountOfPoints {
    public static int points(String[] games) {
        ...
        for (int i = 0; i < games.length; i++) {
            String[] splittedGame = games[i].split(":");

            if (Integer.valueOf(splittedGame[0]) > Integer.valueOf(splittedGame[1])) {
                result += 3;
            }
            else if (Integer.valueOf(splittedGame[0]) == Integer.valueOf(splittedGame[1])) {
                result += 1;
            }
        }
